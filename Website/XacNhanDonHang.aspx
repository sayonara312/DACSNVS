    ...
    <table style="padding: 25px; width: 96%; height: 182px;">
        ...
        <tr>
            <td style="width: 863px">Thông tin đơn đặt hàng của quý khách đã được chúng tôi ghi nhận.<br />
                ...
                Khi cần quý khách có thể liên hệ chúng tôi qua số điện thoại của trung tâm chăm sóc khách hàng03956121358<br />
                <br />
                Xin cảm ơn</td>
        </tr>
        <tr>
            <td style="text-align: right; width: 863px">
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/TrangChu.aspx">Tiếp Tục Mua Sắm</asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
