                ...
                <tr>
                    <td>
                        <div class="text-center">
                            <asp:GridView ID="gvSP" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="MaSP" OnPageIndexChanging="gvSP_PageIndexChanging" Width="100%" OnRowCommand="gvSP_RowCommand" AllowSorting="False" PageSize="20">
                                <Columns>
